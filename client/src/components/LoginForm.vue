    ...
    <div v-if="!isAuth">
      <div v-if="!isAuth" class="">
        <div class="grid grid-cols-1 gap-6">
          ...
          <button @click="submit" class="inline-flex items-center justify-center px-5 py-1 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-teal-600 border border-transparent rounded-md hover:bg-teal-800 focus:outline-none">Login <span v-if="isLoading">...</span></button>
